<body>
  ...
  <br>All parts except the seal are printed in <B>ABS</B> (esun ABS+ following the Voron print guidelines - 40% infill) the seal is printed in <B>TPU</B> (Bavaria Filaments TPU98). I recommend printing the (a)_outter_thermo_case upside down, in my case no supprt was needed.
  </div>
<div>
  <hr>
  ...
  <dl>
    ...
    <dd align="left" width="250">Align the stencil with the hole from step two and the chalkline.</dd>
